                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="intro-body">
                            <h1 class="intro-title mb-4" style="font-size:190%; font-weight:300; text-shadow:2px 2px 2px #000; ">{{ $sliderSingle->title }}</h1>
                            <p class="intro-subtitle intro-price">
                                <a href="#"><span class="price-a">${{ $sliderSingle->price }}</span></a>
                            </p>
                            <p>{{  $sliderSingle->city }} | {{ $sliderSingle->country }}</p>
